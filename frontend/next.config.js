...
const ContentSecurityPolicy = `
  default-src 'self' https://fonts.googleapis.com ${process.env.NEXT_PUBLIC_SUPABASE_URL} https://api.june.so https://www.Synthiq.app/; 
  ...
  script-src 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com/  https://www.Synthiq.app/;
  frame-ancestors 'none';
  style-src 'unsafe-inline' https://www.Synthiq.app/;
`;
